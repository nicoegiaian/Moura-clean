...
{
	$statement = "SELECT p.sucursalmoura
...
{
	$statement = "SELECT p.razonsocial
			FROM puntosdeventa p			
			WHERE p.comercio = ?			
        ";
...
{
	$statement = "SELECT p.nroreferencia
			FROM puntosdeventa p			
			WHERE p.comercio = ?			
        ";
...
{
	$statement = "SELECT p.liquidabind
			FROM puntosdeventa p			
			WHERE p.comercio = ?		
        ";
...
function obtenerEstadoCheque($dbConnection, $comercio, $fecha_liquidacion)
{
	...
	$statement = "SELECT s.porcentajepdv
			FROM puntosdeventa p
			JOIN splits s 
				ON p.id = s.idpdv
			WHERE p.comercio = ?
...
function obtenerPorcentajesDeducciones($dbConnection, $fecha_liquidacion)
{
	...
	$statement = "SELECT p.idporcentaje, p.porcentaje
			FROM porcentajes p
